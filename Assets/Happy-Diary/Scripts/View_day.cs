...
public class View_day : MonoBehaviour
{
    ...
    {
        string s_body_msg = this.GetComponent<App>().carrot.L("del_tip", "Are you sure delete this selected item?");
        
        if (index_func_del == 1) this.msg_question = this.GetComponent<App>().carrot.Show_msg(this.GetComponent<App>().carrot.L("emoji", "Emoji"), s_body_msg, this.act_del_emoji_yes, this.act_del_no);
        if (index_func_del == 2) this.msg_question = this.GetComponent<App>().carrot.Show_msg(this.GetComponent<App>().carrot.L("event", "Event"), s_body_msg, this.act_del_notice_yes, this.act_del_no);
        if (index_func_del == 3) this.msg_question = this.GetComponent<App>().carrot.Show_msg(this.GetComponent<App>().carrot.L("note", "Note"), s_body_msg, this.act_del_note_yes, this.act_del_no);
        if (index_func_del == 4) this.msg_question = this.GetComponent<App>().carrot.Show_msg(this.GetComponent<App>().carrot.L("photo_souvenir", "Souvenir photos"), s_body_msg,this.act_del_photo_yes, this.act_del_no);
    }
