...
public class Notification_Manager : MonoBehaviour
{
    ...
    private void received_notice(int id_notice,string s_msg)
    {
        ...
        Carrot_Window_Msg msg=this.GetComponent<App>().carrot.show_msg(PlayerPrefs.GetString("event","Event"),s_msg);
        msg.add_btn_msg(PlayerPrefs.GetString("appointment_schedule", "Appointment schedule"), act_notice_view);
        msg.add_btn_msg(PlayerPrefs.GetString("cancel","Cancel"), act_notice_close);
